...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        # If actions Q value are same, we return a list of the highest values
        maxQ = 0
        actions_list = list()
        ...
        for action in action_dict:
            if action_dict[action] > maxQ:
                # Update value
                maxQ = action_dict[action]
                # Clear List
                actions_list = []
                actions_list.append(action)

            elif action_dict[action] == maxQ:
                actions_list.append(action)
